...
namespace Trakx.Shrimpy.ApiClient
{
    ...
    {
        private string _baseUrl = "https://dev-api.shrimpy.io/v1";
        ...
        public async System.Threading.Tasks.Task<Response<System.Collections.Generic.List<ExchangeInfo>>> ListExchangesAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/list_exchanges");
            ...
            try
            {
                using (var request_ = await CreateHttpRequestMessageAsync(cancellationToken).ConfigureAwait(false))
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.List<ExchangeInfo>>(response_, headers_).ConfigureAwait(false);
    ...
    internal partial class UsersClient : AuthorisedClient, IUsersClient
    {
        ...
        public async System.Threading.Tasks.Task<Response<System.Collections.Generic.List<Account>>> ListAccountsAsync(System.Guid userId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/users/{userId}/accounts");
            urlBuilder_.Replace("{userId}", System.Uri.EscapeDataString(ConvertToString(userId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task<Response<Account>> GetAccountAsync(System.Guid userId, double exchangeAccountId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/users/{userId}/accounts/{exchangeAccountId}");
            urlBuilder_.Replace("{userId}", System.Uri.EscapeDataString(ConvertToString(userId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    internal partial class TradingClient : AuthorisedClient, ITradingClient
    {
        ...
        public async System.Threading.Tasks.Task<Response<GetBalanceResponse>> GetBalanceAsync(System.Guid userId, double exchangeAccountId, System.DateTimeOffset? date = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/users/{userId}/accounts/{exchangeAccountId}/balance?");
            urlBuilder_.Replace("{userId}", System.Uri.EscapeDataString(ConvertToString(userId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{exchangeAccountId}", System.Uri.EscapeDataString(ConvertToString(exchangeAccountId, System.Globalization.CultureInfo.InvariantCulture)));
            if (date != null) 
            {
    ...
    internal partial class MarketDataClient : AuthorisedClient, IMarketDataClient
    {
        ...
        public async System.Threading.Tasks.Task<Response<System.Collections.Generic.List<Ticker>>> GetTickerAsync(string exchange, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/exchanges/{exchange}/ticker");
